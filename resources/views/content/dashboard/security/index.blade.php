                    ...
                    <table class="table security-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <span class="badge bg-{{ $log->event_type_color }} me-2">
                                ...
                                <td>
                                    ...
                                    @if($log->isHighRisk())
                                        <small class="d-block text-danger">
                                            <i class="ti ti-alert-triangle"></i> {{ $log->risk_level }}
                                        </small>
                                    @endif
                                </td>
                                <td>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="list-group">
                                ...
                                <a href="{{ route('dashboard.security.analytics.index') }}" class="list-group-item list-group-item-action">
                                    <div class="d-flex align-items-center">
                                        <i class="ti ti-chart-bar me-2"></i>
                                        {{ __('Security Analytics') }}
                                    </div>
                                </a>
                                <a href="{{ route('dashboard.security.ip-management.blocked-ips') }}" class="list-group-item list-group-item-action">
                                    <div class="d-flex align-items-center">
                                        <i class="ti ti-ban me-2"></i>
                                        {{ __('Manage Blocked IPs') }}
                                    </div>
                                </a>
                                <a href="{{ route('dashboard.security.ip-management.trusted-ips') }}" class="list-group-item list-group-item-action">
                                    <div class="d-flex align-items-center">
